            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted m-b-30">
                                            Seleccione los voluntarios asignados.
                                        </p>

                                        <form class="form-horizontal">
                                            <c:forEach var="var" items="${items}" varStatus="i">
                                                <div class="custom-control custom-checkbox">
                                                    <input<c:if test="${!empty var.donacion_voluntario_id}"> checked</c:if> type="checkbox" class="custom-control-input" id="nota_${i.count}" name="notaid" value="${var.voluntario_id}">
                                                    <label class="custom-control-label" for="nota_${i.count}">${var.nombre} ${var.apellido}</label>&nbsp; 
                                                    <c:if test="${!empty var.responsable}">
                                                        <c:if test="${resp == 0}">
                                                            <c:if test="${!var.responsable}"><a class="text-primary" href="setresponsable?id=${var.donacion_voluntario_id}"><small>No responsable</small></a></c:if>
                                                            <c:if test="${var.responsable}"><a class="text-white bg-success" href="setresponsable?id=${var.donacion_voluntario_id}"><strong>&nbsp;&nbsp;Responsable&nbsp;&nbsp;</strong></a></c:if>
                                                        </c:if>
                                                        <c:if test="${resp > 0}">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="<c:url value="/empresa/donations"/>" class="btn btn-primary waves-effect waves-light m-b-20"><i class="md md-add"></i> Finalizar </a>
