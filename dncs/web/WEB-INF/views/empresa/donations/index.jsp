                                            ...
                                            <tbody>
                                                <c:forEach var="c" items="${list}" varStatus="i">
                                                    <tr>
                                                        ...
                                                        <td>${c.estado}</td>
                                                        <td class="actions">
                                                            <a href="<c:url value="/empresa/donation?id=${c.donacion_id}"/>" class="btn waves-effect waves-light btn-custom btn-xs"> <i class="fa fa-pencil"></i> </a>
                                                            <a href="<c:url value="/empresa/donationpend?id=${c.donacion_id}"/>" class="btn waves-effect waves-light btn-purple btn-xs"> <i class="fa fa-eye"></i> </a>     
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
