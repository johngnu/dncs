                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title m-t-0 m-b-30">Registrar donacion</h4>
                                        ...
                                        <form action="savedonation" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="rol">Donante<span class="text-danger">*</span></label>
                                                <select name="donante" class="form-control" id="rol">
                                                    <c:forEach var="c" items="${list}">
                                                        <option value="${c.donante_id}">${c.nombre} ${c.apellidos}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
