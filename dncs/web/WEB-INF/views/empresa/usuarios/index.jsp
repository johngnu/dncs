                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <c:forEach var="c" items="${users}" varStatus="i">
                                                    <tr>
                                                        <td>${i.count}</td>
                                                        ...
                                                        <td>${c.usuario}</td>
                                                        <td class="actions">
                                                            <a href="<c:url value="/empresa/usuario?id=${c.usuario_id}"/>" class="btn waves-effect waves-light btn-custom btn-xs"> <i class="fa fa-pencil"></i> </a>                                                            
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
