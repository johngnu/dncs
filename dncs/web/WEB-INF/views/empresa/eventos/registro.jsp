                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title m-t-0 m-b-30">Registrar evento</h4>
                                        <p class="text-muted m-b-20">
                                            Completa todos los datos necesarios: <code>Descripción</code>, <code>Fecha</code>, <code>Ubicación</code>, <code>Ciudad</code>.
                                        </p>

                                        <form action="guardarevento" method="post">
                                            <div class="form-group">
                                                <label for="descripcion">Descripción<span class="text-danger">*</span></label>
                                                <input type="text" name="descripcion" parsley-trigger="change" required
                                                       placeholder="Descripción del evento" class="form-control" id="descripcion">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ubicacion" parsley-trigger="change" required
                                                       placeholder="Ubicación del evento" class="form-control" id="ciudad">
                                            </div>
                                            <div class="form-group">
                                                <label for="ciudad">Ciudad<span class="text-danger">*</span></label>
                                                <input type="text" name="ciudad" parsley-trigger="change" required
                                                       placeholder="Ciudad del evento" class="form-control" id="ciudad">
                                            </div>
