                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <c:forEach var="c" items="${eventos}" varStatus="i">
                                                    <tr>
                                                        <td>${i.count}</td>
                                                        <td><fmt:formatDate value="${c.fecha}" pattern="d-MMM-yy"/></td>
                                                        <td>${c.descripcion}</td>
                                                        <td>${c.ubicacion}</td>
                                                        <td>${c.ciudad}</td>
                                                        <td class="actions">
                                                            ...
                                                            <a href="<c:url value="/empresa/evento?id=${c.evento_id}"/>" class="btn waves-effect waves-light btn-custom btn-xs"> <i class="fa fa-pencil"></i> </a>
