                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="m-t-0 header-title"><b>ID - ${norma.norma_id}</b></h4>
                                        <p class="text-muted m-b-30">
                                            Información completa de la norma: <code>Descripción</code>, <code>Fecha</code>, <code>Ubicación</code>, <code>Ciudad</code>.
                                        </p>
                                        ...
                                        <ul class="nav nav-tabs tabs-bordered" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab-b1" data-toggle="tab" href="#contenido-b1" role="tab" aria-controls="contenido-b1" aria-selected="true">
                                                    ...
                                                    <span class="d-none d-sm-block">Archivo</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="home-b1" role="tabpanel" aria-labelledby="home-tab-b1">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <form class="form-horizontal" action="actualizarnorma" method="post">
                                                            <div class="form-group row">
                                                                <label class="col-md-3 control-label">Descripción</label>
                                                                <div class="col-md-9">
                                                                    <input name="descripcion" type="text" class="form-control" value="${norma.descripcion}" placeholder="" required>
                                                                </div>
                                                            </div>   
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <textarea name="observacion" class="form-control" placeholder="Ingrese una nota u observación para este registr">${norma.observacion}</textarea>
                                                                </div>
                                                            </div>     
                                                            ...
                                                            <input type="hidden" name="id" value="${norma.norma_id}">
                                                        </form>
                                                    </div> <!-- end col -->
                                                </div>
                                                <!-- end row -->
                                            ...
                                            <div class="tab-pane" id="contenido-b1" role="tabpanel" aria-labelledby="contenido-tab-b1">
                                                <p>Archivo relacionado a la normativa registrada.</p>
                                                
                                                <embed src="<c:url value="/empresa/openfile"/>?id=${norma.filedata}" frameborder="0" width="100%" height="400px" class="file-view">
                                                <p>This browser does not support PDFs. Please download the PDF to view it: <a href="<c:url value="/empresa/openfile?id=${norma.filedata}"/>">Descargar PDF</a>.</p>
