                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title m-t-0 m-b-30">Registrar donante</h4>
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="empresa-tab" data-toggle="tab" href="#empresa" role="tab" aria-controls="empresa" aria-selected="false">        
                                                    ...
                                                    <span class="d-none d-sm-block">Organización</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="persona" role="tabpanel" aria-labelledby="persona-tab">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form action="guardardonante" method="post">
                                            ...
                                            <div class="tab-pane" id="empresa" role="tabpanel" aria-labelledby="empresa-tab">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <p class="text-muted m-b-20">
                                                            Donante tipo: <code>Organicación</code>.
                                                        </p>
                                                        ...
                                                        <form action="guardardonante" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Tipo cliente</label>
                                                                <p class="form-control-static"> Organicación </p>
