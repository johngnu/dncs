                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th data-priority="0" style="width: 0px;">#</th>
                                                    <th>Descripción</th>
                                                    <th style="width: 0px;"> Acción </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="c" items="${list}" varStatus="i">
                                                    <tr>     
                                                        ...
                                                        <td>${c.descripcion}</td>
                                                        <td class="actions">                                                            
                                                            <a href="<c:url value="/empresa/producto?id=${c.categoria_id}"/>" class="btn waves-effect waves-light btn-custom btn-xs"> <i class="fa fa-pencil"></i> </a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
