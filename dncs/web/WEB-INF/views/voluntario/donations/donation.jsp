                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">                                                       
                                                <c:if test="${!donation.soyvoluntario}"><a href="<c:url value="soyvoluntario?id=${donation.donacion_id}"/>" class="btn btn-success waves-effect waves-light">Asignarme como voluntario <i class="mdi mdi-plus-circle-outline"></i></a></c:if>
                                                <c:if test="${donation.soyvoluntario}"><a href="<c:url value="soyvoluntario?id=${donation.donacion_id}"/>" class="btn btn-danger waves-effect waves-light">Salir como voluntario <i class="mdi mdi-plus-circle-outline"></i></a></c:if>                                                
                                            </div>
                                        </div>
                                    </div>
                                </div>
