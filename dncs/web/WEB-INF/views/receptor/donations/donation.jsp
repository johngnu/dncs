...
<html lang="es">
    ...
    <body>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                                            ...
                                            <tbody>
                                                <c:forEach var="d" items="${donationdetail}" varStatus="i">
                                                    <tr>
                                                        ...
                                                        <td> ${d.cantidad} </td>
                                                        <td class="actions">                                                            
                                                            <button data-id="${d.solicitud_detalle_id}" class="btn waves-effect waves-light btn-danger btn-xs sa-params"> <i class="fa fa-trash-o"></i> </button>
                                                        </td>
                                                    </tr>
                                                </c:forEach>   
                                            </tbody>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="<c:url value="/receptor/donation?id=${donation.solicitud_id}"/>" class="btn btn-primary waves-effect waves-light m-b-20"><i class="md md-add"></i> Finalizar </a>
        ...
        <!-- modal -->
        <div id="addproducto1" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="addproductoLabel1" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <table class="table table-striped add-edit-table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                <th data-priority="0"> Categoría </th>
                                <th> Detalles</th>
                                <th> Cantidad </th>
                                <th data-priority="1"> Acción </th>
                            </tr>
                        ...
                        <tbody>
                            <c:forEach var="d" items="${categorias}" varStatus="i">
                                <tr>
                                    <td> ${d.descripcion} </td>
                                    <td> ${d.detalle} </td>
                                    <td> ${d.cantidad} </td>
                                    <td class="actions">                                                            
                                        <a href="additem?id=${d.donacion_detalle_id}&solicitud=${donation.solicitud_id}" class="btn waves-effect waves-light btn-primary btn-xs"> <i class="fa fa-arrow-circle-o-right"></i> </a>
                                    </td>
                                </tr>
                            </c:forEach>   
                        </tbody>
